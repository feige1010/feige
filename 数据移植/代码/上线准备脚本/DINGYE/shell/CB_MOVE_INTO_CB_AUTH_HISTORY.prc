...
SELECT  SRVRTID,
        ...
        (SELECT OP.OPER_NAME FROM FIRMBANK_DINGYE.T_OPERATOR OP WHERE OID = HIST.CALLER AND ROWNUM = 1) AS OPER_NAME,
        ...
        (CASE 
         ...
         END)as AUTHLVL,
         '0' as AUTHFLAG
FROM FIRMBANK_DINGYE.T_TRANSFER TRANS, (
SELECT *
  FROM FIRMBANK_DINGYE.T_BF_HISTORY_STEP HIST1
 ...
 HIST1.FINISH_TIME) IN
       (SELECT HIST2.ID_ENTRY,
          ...
          FROM FIRMBANK_DINGYE.T_BF_HISTORY_STEP HIST2

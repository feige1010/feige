...
SELECT  netflow.TRANFLOW_NO,
        ...
        '0',
        netflow.ACCT_NO,
        (select cst.name from PERBANK_ZHIJIANG.t_customer cst, PERBANK_ZHIJIANG.t_account acc
        ...
        '00000000'
FROM
PERBANK_ZHIJIANG.t_NETTRAN_FLOW netflow,  PERBANK_ZHIJIANG.t_TRANS_FLOW tranflow
